...
public class RaceClassificationService : IRaceClassificationService
{
    ...
    public async Task<IEnumerable<RaceResultItemDto>> GetAll()
    {
        ...
        var raceResultItemDtos = new List<RaceResultItemDto>();
    ...
    public async Task<RaceResultItemDto> Create(RaceResultItemForCreationDto raceResultItemForCreationDto)
    {
        var selectedPosition =
            (await _repositoryManager.PositionRepository.FindByCondition(x =>
                x.Rank == raceResultItemForCreationDto.Postion)).FirstOrDefault();
        ...
        if (selectedRaceweek == null || selectedPosition == null || selectedBooking == null) return null;

        var newRaceClassification = new RaceClassification
        {
    ...
    public async Task<bool> Exist(string driver, string circuit, string season, string position)
    {
        ...
        if (selectedPosition == null || selectedBooking == null || selectedRaceweek == null) return false;
