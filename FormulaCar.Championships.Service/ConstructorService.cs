...
public class ConstructorService : IConstructorService
{
    ...
    public async Task<ConstructorDto> CreateConstructor(ConstructorForCreationDto constructorForCreationDto,
        CancellationToken cancellationToken = default)
    {
        ...
        var country =
            countries.FirstOrDefault(x => x.Name.ToLower().Contains(constructorForCreationDto.CountryCode.ToLower()));
    ...
    {
        var countryDtos = new List<ConstructorDto>();
        ...
        foreach (var constructor in constructors)
        {
            ...
            if (country == null) throw new ItemNotFoundException(constructor.CountryId);
